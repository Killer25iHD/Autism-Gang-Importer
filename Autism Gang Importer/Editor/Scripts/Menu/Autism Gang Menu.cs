...
namespace AutismImporter
{
    ...
    public partial class AutismGangMenu : EditorWindow
    {
        ...
        public int tabs = 3;
        string[] tabOptions = new string[] { "Welcome", "Importer", "Credits" };

        [MenuItem("𝓐𝓾𝓽𝓲𝓼𝓶 𝓖𝓪𝓷𝓰/𝓘𝓶𝓹𝓸𝓻𝓽𝓮𝓻", false, 600)]

        static void ShowImportPanel()
        {
            window = (AutismGangMenu)EditorWindow.GetWindow(typeof(AutismGangMenu));
